...
//        apiClient.setApiKeyPrefix("api-key");

        TransactionalEmailsApi transactionalEmailsApi = new TransactionalEmailsApi(apiClient);

        SendSmtpEmail sendSmtpEmail = new SendSmtpEmail();
        sendSmtpEmail.setSender(new SendSmtpEmailSender().name("Resume Analyser").email("riddhiagrawal2509@gmail.com"));
        ...
        try{
            ...
            System.out.println("===== BREVO ERROR START =====");
            System.out.println("Status Code: " + e.getCode());
            System.out.println("Response Body: " + e.getResponseBody());
            System.out.println("Message: " + e.getMessage());
            e.printStackTrace();
            System.out.println("===== BREVO ERROR END =====");
