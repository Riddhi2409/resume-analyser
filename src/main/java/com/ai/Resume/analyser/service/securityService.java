...
public class securityService {
    ...
    public ResponseEntity<?> verifyEmail(@Valid verifyEmailOtp verifyEmail) {
        System.out.println("===== VERIFY EMAIL API CALLED =====");
        System.out.println("Email received: " + verifyEmail.getEmail());

        boolean exists = usersTableRepository.existsById(verifyEmail.getEmail());
        System.out.println("Does email already exist in DB? " + exists);
